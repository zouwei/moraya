...
<div class="source-editor-outer" role="presentation" class:hide-scrollbar={hideScrollbar} class:has-outline={showOutline} bind:clientHeight={outerHeight} onclick={(e) => {
