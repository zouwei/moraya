 ...
 *
 * Calls `createSchema()` from `@moraya/markdown-core` with Tauri-specific DI
...
import { createSchema, setDocumentBaseDir, getDocumentBaseDir } from '@moraya/markdown-core'
